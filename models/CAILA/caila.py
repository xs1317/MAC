...
import math
from models.CAILA.losses import MixupClassLoss
from models.CAILA.clip import CLIPModel
from transformers import CLIPModel as t_CLIPMODEL
from transformers.models.clip.configuration_clip import CLIPConfig
from transformers import CLIPProcessor
import os
from models.CAILA.plain_clip import PlainClip

def get_caila(dataset,args,device):
    is_open = False

    if args.model_name == 'CAILA':
    ...
    elif args.model_name == 'plainclip':
...
class CAILA(nn.Module):
    def __init__(self, dset, args):
        ...
        ckpt = t_CLIPMODEL.from_pretrained("openai/{}".format(args.clip_config))
