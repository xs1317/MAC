...
import sys 
sys.path.append("/root/autodl-tmp/Models/csp")
print(sys.path)
...
def load_glove_embeddings(vocab):
    ...
    emb_file = "/root/autodl-tmp/data/CZSL/glove.6B.300d.txt"
...
if __name__ == "__main__":
    ...
    save_path =  f'/root/autodl-tmp/data/CZSL/feasibility_{config.dataset}.pt'
    torch.save({
